...
if __name__ == "__main__":
    ...
    if extract_information:
        ...
        for report_path in report_paths:
            ...
            patient.save_to_csv(ORDERED_FIELDS, csv_path="reports_extracted_test_729_1066reports_Meltemi_fewshots.csv")
    ...
    path_pred="reports_extracted_test_729_1066reports_Meltemi_fewshots.csv",
