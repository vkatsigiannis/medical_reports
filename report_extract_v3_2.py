...
if __name__ == "__main__":
    ...
    if extract_information:
        ...
        for report_path in report_paths:
            ...
            patient.save_to_csv(ORDERED_FIELDS, csv_path="reports_extracted_test2.csv")
            print('\n')
            

    lib.model_performace(path_pred="reports_extracted_test2.csv", path_gt='GT - edit.xlsx', per_class_breakdown=True)