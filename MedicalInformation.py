...
class CurveMorphology:
    ...
    _fewshots = ("""
        ...
        Text:
        «ΕΝΔΕΙΞΗ: ...
                 εστιακή αλλοίωση διαμέτρου 5,8 χιλ. στην παρούσα εξέταση με σκιαγραφική ενίσχυση και αιμοδυναμική καμπύλη τύπου III»
        Output:
        "3"
        ...
        Text:
        «ΕΝΔΕΙΞΗ: ...
                (δεν γίνεται αναφορά σε αιμοδυναμική καμπύλη)
                 ...»
        Output:
        null
    """)
...
class LATERALITY:
    ...
    _fewshots = ("""
        ...
        Example 1 (in ΕΝΔΕΙΞΗ or ΣΥΜΠΕΡΑΣΜΑ)
        Text:
        ΕΝΔΕΙΞΗ or ΣΥΜΠΕΡΑΣΜΑ: ...
                 - Κυστικές αλλοιώσεις διαμέτρου ολίγων χιλιοστών ελέγχονται σε αμφότερους τους μαζικούς αδένες, ορισμένες εκ των οποίων ελέγχονται επιλεγμένες.»
        Output:
        "BILATERAL"

        Example 2 (in ΕΝΔΕΙΞΗ or ΣΥΜΠΕΡΑΣΜΑ)
        Text:
        ΕΝΔΕΙΞΗ or ΣΥΜΠΕΡΑΣΜΑ: ...
                10ης ώρας του αριστερού μαστού και εν τω βάθει θέση ~8,3 εκ. οπισθοθηλαία καθίσταται πιο εμφανής στην σημερινή εξέταση αλλοίωση διαμέτρου 7,5 χιλ.
                 ...
                 Στο κάτω έσω τεταρτημόριο του δεξιού μαστού και σε εν τω βάθει θέση ~7 εκ. οπισθοθηλαία επανελέγχεται ωοειδής αλλοίωση διαμέτρου 7 χιλ.
                 ...»
        Output:
        "BILATERAL"

        Example 3 (in ΕΝΔΕΙΞΗ or ΣΥΜΠΕΡΑΣΜΑ)
        Text:
        ΕΝΔΕΙΞΗ or ΣΥΜΠΕΡΑΣΜΑ: ...
                 αλλοιώσεις αριστερά»
        Output:
        ...
        Example 4 (in ΕΝΔΕΙΞΗ or ΣΥΜΠΕΡΑΣΜΑ)
        Text:
        ΕΝΔΕΙΞΗ or ΣΥΜΠΕΡΑΣΜΑ: ...
                 Στο κέντρο του δεξιού μαστού και 10 εκ. οπισθοθηλαία παρατηρείται οζώμορφη αλλοίωση, διαμέτρου 7 χιλ.»
        Output:
        ...
        Example 5 (in ΕΝΔΕΙΞΗ or ΣΥΜΠΕΡΑΣΜΑ)
        Text:
        ΕΝΔΕΙΞΗ or ΣΥΜΠΕΡΑΣΜΑ: ...
                (δεν γίνεται αναφορά σε θέση ευρημάτων/βλαβών ή αναφέρονται μόνο τεχνικά/παρασκηνιακά ευρήματα)
                 ...»
        Output:
        null
    """)
